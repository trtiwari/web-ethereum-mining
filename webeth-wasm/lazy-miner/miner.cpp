...
void store(std::string dagStr, unsigned int startIndex,unsigned int endIndex)
{
		...
		for (unsigned int i = start; i < end; i = i+16)
		{
...
double mine(std::string headerStr, std::string cacheStr, std::string dagStr,unsigned int startIndex, unsigned int endIndex, unsigned int cacheSize, unsigned int dagSize)
{
	...
	numSlicesLocal = 16777186;//3355438;
	...
	// while((float)cacheHit/(float)numAccesses < 0.99999)
	{

...
\begin{figure}[h]
\centering
\includegraphics[width=300px,keepaspectratio]{Native_C++_Miner_Hash_Rate_HM.pdf}
\caption{\label{fig:NativeMinerHM} Native Miner: $\log{Hash Rate}$}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=300px,keepaspectratio]{WebAssembly_Miner_Hash_Rate_HM.pdf}
\caption{\label{fig:WebAsmMinerHM} WebAssembly Miner: $\log{Hash Rate}$}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=300px,keepaspectratio]{JavaScript_Miner_Hash_Rate_HM.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=300px,keepaspectratio]{All_Miners_Buffer_Hit_Rate_Percent.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=300px,keepaspectratio]{Native_Miner_vs_WebAssembly_miner_Hash_Rate_Percent_Improvement.pdf}
\caption{\label{fig:NativeWebAsm} Native miner vs. WebAssembly miner Hash Rate Percent Improvement}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=300px,keepaspectratio]{WebAssembly_Miner_vs_JavaScript_miner_Hash_Rate_Percent_Improvement.pdf}
\caption{\label{fig:WebAsmJS} WebAssembly miner vs. JavaScript miner Hash Rate Percent Improvement}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=300px,keepaspectratio]{Native_Miner_vs_JavaScript_miner_Hash_Rate_Percent_Improvement.pdf}
